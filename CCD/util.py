...
def parse_args():
    ...
    parser.add_argument("--task_type", type=str, default="clone")
...
def build_model_tokenizer_config(args):
    ...
    if args.method in ["prefix", "prompt", "lora", "ewc", "emr", "finetune", "pp_old"]:
        model_classes = {
            "codebert": (RobertaForSequenceClassification, RobertaTokenizer, RobertaConfig, "../pretrained/codebert"),
    ...
    elif args.method in ["pp"]:

        model_classes = {
            "codebert": (RobertaModel, RobertaTokenizer, RobertaConfig, "../pretrained/codebert"),
    ...
    # config.max_position_embeddings = 2 * args.max_input_tokens
