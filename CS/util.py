...
import torch
import os
from transformers import T5ForConditionalGeneration, T5Config, RobertaTokenizer, RobertaModel, RobertaConfig
...
def parse_args():
    ...
    parser.add_argument("--task_type", type=str, default="sum")
...
def build_model_tokenizer_config(args):
    ...
    model_classes = {
        ...
        "codet5": (T5ForConditionalGeneration, RobertaTokenizer, T5Config, "../pretrained/codet5")
    }
